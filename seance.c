...
int addSeance(Seance *seance){
    ...
    sql = "INSERT INTO seance (idDossier,dateSeance_year,dateSeance_month"
          ",dateSeance_day,dateSeanceSuiv_day"
          ",dateSeanceSuiv_day,dateSeanceSuiv_day,observations,nomSeance) "
          "VALUES (?,?,?,?,?,?,?,?,?)";
    ...
    sqlite3_bind_text(stmt,8,seance->nomSeance,-1,SQLITE_TRANSIENT);
